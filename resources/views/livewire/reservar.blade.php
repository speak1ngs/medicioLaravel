						...
						<table id="mytable" class="table table-bordred table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>21/03/2023</td>
									<td>
										<p data-placement="top" data-toggle="tooltip" title="reservar">


											<button class="btn btn-primary btn-xs" data-title="Reservar"
												data-toggle="modal" data-target="#Reservar"><span

...
<x-body-wrapper >
	...
	<div class="container well">
		<h3 class="mb-0"> Reservar Turno Administrador</h3>
		<hr>
	...
	<div class="py-5">
		<div class="container well">
			<div class="row mb-4 align-items-center flex-lg-row-reverse">
				<div class="col-md-6 col-xl-5">
					<div class="lc-block mb-3">
						<div editable="rich">
							<h1 class="fw-bolder display-2">Lorem ipsum dolor sit</h1>
						</div>
					</div>
					...
					<div class="lc-block mb-4">
						<div editable="rich">
							...
							<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam velit
								temporibus impedits maxime repellendus esse tempore odio voluptatum iusto consectetur
								voluptates.</p>
			...
			<div class="row ">
				...
				<div class="col-md-12">
					<h4>Dias disponibles del doctor</h4>
						...
						<table id="mytable" class="table table-bordred table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>Hospital test</td>
									<td>
										<a href="https://goo.gl/maps/EYYfsz9uUMCq238N6" target=_blank>Ver Ubicacion</a>
									</td>
									<td>
				...
				<div class="modal-content modal-content-scroll">
					...
					<div class="modal-footer ">
						<button type="button" class="btn btn-warning btn-lg" style="width: 100%;"
							data-title="userDetail" data-toggle="modal" data-target="#userDetail"
	...
	<div class="container">
		<div class="modal fade" id="userDetail" tabindex="-1" role="dialog" aria-labelledby="userDetail"
			aria-hidden="true">
			<div class="modal-dialog modal-content-scroll" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<!-- hid-search -->
						<div class="row hid-search">

							<div class="col-md-12 top-button center-block">
								<button type="submit" class="btn btn-skin btn-sm">Buscar</button>
							</div>
						</div>
						<hr class="bottom-p">
						<label class="hid-search">Paciente</label>
						<div class="row hid-search">
					...
					<div class="modal-footer ">
						<button type="button" class="btn btn-warning btn-lg" style="width: 100%;"
							...
							data-dismiss="modal" data-target="#pagarReserva"><span></span>Generar reserva
							temporal</button>
					</div>
				</div>
				<!-- /.modal-content -->
				...
				<div class="modal-content">
					...
					<div class="modal-footer ">
						<button type="button" class="btn btn-warning btn-lg" style="width: 100%;"
							...
							data-dismiss="modal" data-target="#failPayment"><span></span>Generar reserva
							temporal</button>
					</div>
				</div>
				<!-- /.modal-content -->

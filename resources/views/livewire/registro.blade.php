            ...
            <div class="container well"   >
                ...
                <form>
                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" class="form-control" id="inputEdad" wire:model="inputEdad" placeholder="Edad">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                                                ...
                                                                                <select id="inputBarrio" class="form-control" wire:model="inputBarrio">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                                                ...
                                                                                <select id="inputCiudad" class="form-control"  wire:model="inputCiudad">
                            ...
                            <button type="button" class="btn btn-skin btn-lg" wire:click="guardar()">Registrame</button>

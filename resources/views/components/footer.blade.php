...
<script src="{{ mix('js/jquery.scrollTo.js')}}"></script>
<script src="{{ mix('js/jquery.appear.js')}}"></script>
<script src="{{ mix('js/stellar.js')}}"></script>
<script src="{{ mix('plugins/cubeportfolio/js/jquery.cubeportfolio.min.js')}}"></script>
